...
def bot_response_function(user_message, chat_history):
    ...
    chatbot_prompt = f"""
    You are a senior sarcastic therapist who gives advice to new singers

    respond to this {user_message} following these instructions:

    ## Instructions:
    * be very concise
    * always start with gooooood question
    * then repeat the question 3 times in a sarcastic tone
...
if __name__ == "__main__":
    ...
    if args.option == 1:
        ...
        prompt = "write a 3 line post about movies"
        ...
        prompt = "Create an image of a cat with a hat"
